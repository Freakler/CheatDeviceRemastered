...
const Menu_pack main_menu[] = {
  ...
  {"Vehicle Spawner: "                , CAT_ALIAS   , MENU_VALUE       , TRUE  , TRUE  , TRUE  , FALSE , 0      , -1  , vehicle_spawner      , "CROSS/SQUARE = Spawn Vehicle"      , "LEFT/RIGHT = Adjust"                , "> Spawns a Vehicle in front of you." },
  ...
  {"Model: "                          , CAT_PLAYER  , MENU_VALUE       , TRUE  , TRUE  , TRUE  , FALSE , 0x1C87 , OFF , player_model         , "CROSS = Change now"                , "LEFT/RIGHT = Select model"          , "> Change the actors skin / model. Beware: May break the game!" },
  ...
  {"Power Jump"                       , CAT_PLAYER  , MENU_SWITCH      , TRUE  , TRUE  , TRUE  , TRUE  , 0x1E4A , OFF , powerjump            , "CROSS = Enable/Disable Cheat"      , ""                                   , "> Hold the jumping key to keep jumping." },
  ...
  {"Default RadioStation: "           , CAT_TRFFIC  , MENU_VALSWITCH   , TRUE  , TRUE  , TRUE  , TRUE  , 0x1B98 , OFF , traffic_radiostation , "CROSS = Enable/Disable Cheat"      , "LEFT/RIGHT = Select Station"        , "> Select a Radio Station that should be played when entering a vehicle."  },
  ...
  {"Pickup Spawner: "                 , CAT_MISC    , MENU_VALUE       , TRUE  , TRUE  , TRUE  , FALSE , 0x1501 , OFF , pickup_spawner       , "CROSS = Create one-time pickup"    , "SQUARE = Create reappearing"        , "> Spawns a Pickup in front of you." },
